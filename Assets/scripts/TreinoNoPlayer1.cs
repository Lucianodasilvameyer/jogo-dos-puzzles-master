...
public class TreinoNoPlayer1 : MonoBehaviour
{
    ...
    [SerializeField]
    Plataforma plataforma; //é necessario fazer esta referencia para usar variaveis da classe plataforma? acho q bastaria q a variavel fosse public
    ...
    public void andarComRotacao() //no exemplo estava só void, mas só void seria private? não haveria como colocar uma função private no LateUpdate?   
    {
        ...
        speed = new Vector3(charController.velocity.x, charController.velocity.y, charController.velocity.z).magnitude; 
